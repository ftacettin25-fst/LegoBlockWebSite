      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-4 lg:px-8">
        <div>
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            Turn your photos into custom BrickHeadz figurines. Designed by you, built brick by brick.
          </p>
        </div>
        <div>
          <h4 className="text-sm font-semibold">Explore</h4>
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            <li><Link to="/create" className="hover:text-foreground">Create</Link></li>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            <li><Link to="/" hash="team" className="hover:text-foreground">Team</Link></li>
            <li><Link to="/" hash="contact" className="hover:text-foreground">Contact</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="text-sm font-semibold">Connect</h4>
          <div className="mt-3 flex items-center gap-3 text-muted-foreground">
            <a href="mailto:hello@grids2bricks.com" className="hover:text-foreground"><Mail className="h-5 w-5" /></a>
