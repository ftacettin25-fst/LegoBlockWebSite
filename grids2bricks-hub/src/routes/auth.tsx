...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Sign in or create an account to save your BrickHeadz designs and track orders.",
      },
        ...
        <Card className="w-full p-6 shadow-elegant sm:p-8">
          <div className="mb-6 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Save your designs and track orders.
            </p>
          </div>
          ...
          <Button onClick={handleGoogle} variant="outline" className="w-full" disabled={submitting}>
            <svg className="h-4 w-4" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <path
                fill="#FBBC05"
                d="M5.84 14.1A6.97 6.97 0 0 1 5.47 12c0-.73.13-1.43.36-2.1V7.07H2.18A11 11 0 0 0 1 12c0 1.77.42 3.45 1.18 4.93l3.66-2.83z"
              />
              <path
                fill="#EA4335"
