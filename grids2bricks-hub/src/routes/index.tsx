...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Turn any photo into a personalized BrickHeadz figurine." },
    ],
  }),
  component: HomePage,
});
    ...
    <SiteLayout>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 max-w-lg text-base text-muted-foreground sm:text-lg">
                Upload a portrait, customize the look, preview it in 3D, and we'll ship a one-of-a-kind BrickHeadz
                figurine of you, your pet, or anyone you love.
              </p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {[
            { icon: Upload, title: "Upload", desc: "Drop a clear, front-facing photo. We'll handle the rest." },
            {
              icon: Box,
              title: "Preview in 3D",
              desc: "Tweak the style, colors, and name plate. Spin it around live.",
            },
            { icon: Truck, title: "Order & ship", desc: "Add to cart, check out, and we'll build and ship it." },
          ].map((step, i) => (
            <Card key={step.title} className="p-6 transition-spring hover:-translate-y-1 hover:shadow-elegant">
              ...
              <div className="mt-4 text-xs font-semibold tracking-widest text-primary">STEP {i + 1}</div>
      ...
      <section className="bg-surface py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between">
            <div>
              <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">Sample BrickHeadz</h2>
              <p className="mt-2 text-muted-foreground">A few favorites from our community.</p>
            </div>
            <Link to="/create" className="hidden text-sm font-semibold text-primary hover:underline sm:inline-flex">
              Make yours →
            </Link>
          </div>
      ...
      <section id="contact" className="mx-auto max-w-7xl scroll-mt-24 px-4 py-20 sm:px-6 lg:px-8">
        <Card className="overflow-hidden border-0 bg-gradient-primary p-8 text-primary-foreground shadow-lift sm:p-12">
          <div className="grid items-center gap-8 md:grid-cols-2">
            <div>
              <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">Ready to build yours?</h2>
              <p className="mt-3 max-w-md text-primary-foreground/80">
                It takes 5 minutes from photo to finished design. Order whenever you're happy with the preview.
              </p>
            </div>
...
const TEAM_PHOTO_REAL = "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&auto=format&fit=crop&q=80";
const TEAM_PHOTO_LEGO = "https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=1200&auto=format&fit=crop&q=80";
      ...
      <div className="mt-12 grid gap-6 lg:grid-cols-4">
        ...
        <Card className="flex flex-col p-6 lg:col-span-1">
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            Designs the brick patterns and obsesses over color accuracy. Turns photos into pixel-perfect builds.
          </p>
        ...
        <Card className="flex flex-col p-6 lg:col-span-1">
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            Builds the 3D pipeline and ships every order on time. Keeps the bricks (and the servers) running.
          </p>
          <div className="mt-auto flex gap-3 pt-5">
            <a
